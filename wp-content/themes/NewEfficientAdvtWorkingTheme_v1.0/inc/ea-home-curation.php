...
function ea_get_home_hero_slides() {
    ...
    $slides = [
        [
            ...
            'eyebrow'         => 'Custom Fabrication · Premium Trade Show Booths',
            'heading'         => 'Elite Exhibition Stands & Event Branding in Dubai',
            'text'            => 'Complete turnkey design, in-house fabrication, and professional venue installation of custom exhibition stands, trade show booths, and premium event signage across the UAE.',
        ...
        [
            ...
            'eyebrow'         => 'High-Impact Fleet Graphics · Nationwide Installation',
            'heading'         => 'Premium Vehicle Branding & Fleet Advertising',
            'text'            => 'Turn your company vehicles into mobile billboards. From individual car wraps to extensive van and truck fleet branding, we deliver flawless vinyl installations and long-term durability.',
            'primary_label'   => 'Browse Catalogue',
            'primary_url'     => '/catalogue/',
            'secondary_label' => 'WhatsApp Us',
            'secondary_url'   => $wa_url,
        ...
        [
            ...
            'eyebrow'         => '3D Lettering · Illuminated Signs · Construction Hoardings',
            'heading'         => 'Corporate Signage Fabrication & Large Format Printing',
            'text'            => 'State-of-the-art 3D metal signs, backlit acrylic storefront letters, massive outdoor hoardings, and premium banners printed using high-resolution latex ink.',
            'primary_label'   => 'Browse Catalogue',
            'primary_url'     => '/catalogue/',
            'secondary_label' => 'WhatsApp Us',
            'secondary_url'   => $wa_url,
...
function ea_get_home_curated_product_ids() {
    ...
    return [
        1082,   // Print & Stationery — Premium Business Cards
...
function ea_get_catalogue_category_descriptions() {
    ...
    return [
        'corporate-gifts'      => 'Branded corporate gifts, promotional items, custom merchandise and giveaways.',
        'exhibitions-events'   => 'Exhibition stands, backdrop walls, promotional counters and event branding solutions.',
        'flags'                => 'Feather flags, teardrop banners, outdoor flags and wind-resistant displays.',
        'large-format'         => 'Roll-up banners, mesh banners, vinyl banners and large-format prints for events and retail.',
        'office-retail-branding' => 'Custom stickers, wall graphics, floor decals and interior branding solutions.',
        'packaging-labels'     => 'Custom packaging boxes, bags, labels and branded wrapping solutions.',
        'print-stationery'     => 'Business cards, brochures, flyers, letterheads and all commercial printing needs.',
...
function ea_get_catalogue_category_image_map() {
    ...
    return [
        'corporate-gifts'        => '/wp-content/uploads/product-sku-images/cg-085.webp',  // Standard Crystal Trophy
        'exhibitions-events'     => '/wp-content/uploads/product-sku-images/ee-008.webp',  // Double-Decker Booth
        'flags'                  => '/wp-content/uploads/product-sku-images/fl-001.webp',  // Standard Feather Flag
        'large-format'           => '/wp-content/uploads/product-sku-images/lf-029.webp',  // Standard Step & Repeat backdrop
        'office-retail-branding' => '/wp-content/uploads/product-sku-images/ob-012.webp',  // Retail Shopfront Window Graphic
        'packaging-labels'       => '/wp-content/uploads/product-sku-images/pl-001.webp',  // Packaging product
        'print-stationery'       => '/wp-content/uploads/product-sku-images/ps-006.webp',  // Gold Foil Spot UV Business Card
