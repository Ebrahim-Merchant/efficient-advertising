<?php
/**
 * Blog page template for /blog/
 * Scope: blog page only (EA-HOMEPAGE-FINAL-ADD-001)
 */
if ( ! defined( 'ABSPATH' ) ) exit;

/* Inject meta description for blog archive page */
add_action( 'wp_head', function() {
    echo '<meta name="description" content="Printing and signage tips, guides, and insights for businesses in Dubai and across the UAE — from Efficient Advertising, in-house printing and branding specialists since 2008." />' . "\n";
}, 1 );
...
<main class="ea-blog-page">
  <section class="ea-blog-hero">
    <div class="ea-blog-container">
      ...
      <p>Practical guides, expert tips, and planning insights to help businesses in Dubai and across the UAE make smarter decisions for signage, printing, branding, and event execution.</p>
    </div>
  </section>
