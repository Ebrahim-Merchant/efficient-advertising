...
.ea-mega-col-title {
  color: #FFC107 !important;
  font-size: 10px; /* Extra compact premium size */
  font-weight: 800;
  text-transform: uppercase;
  margin-bottom: 8px; /* Tightened margin */
  letter-spacing: 0.1em;
  border-bottom: 1px solid rgba(255,255,255,0.12);
  padding-bottom: 4px; /* Tightened padding */
}
.ea-mega-col-list li a {
  color: rgba(255,255,255,0.92) !important;
  font-size: 11px; /* Extra compact readable size */
  font-weight: 600;
  text-decoration: none;
  transition: all 0.25s ease;
  padding: 2.5px 0; /* Tightened item padding */
  display: block;
  line-height: 1.4;
}
