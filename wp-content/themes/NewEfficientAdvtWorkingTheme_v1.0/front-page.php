<?php
/**
 * â–ˆâ–ˆ  DEPRECATED â€” DO NOT USE  â–ˆâ–ˆ
 *
 * Premium Homepage â€” Efficient Advertising LLC
 *
...
/* â”€â”€ ORIGINAL CODE BELOW (inactive â€” guarded above) â”€â”€ */
...
/* â”€â”€ 8 Curated products: one per parent category, with featured image â”€â”€ */
...
if ( ! is_wp_error( $ea_parent_cats ) ) {
  foreach ( $ea_parent_cats as $pcat ) {
    ...
    if ( $prods ) {
      ...
      if ( empty( $excerpt ) ) $excerpt = wp_trim_words( $p->post_content, 12, 'â€¦' );
      $curated[] = [
        'id'       => $p->ID,
        'title'    => $p->post_title,
...
/* â”€â”€ Core services (static â€” curated selection) â”€â”€ */
$services = [
  [
    'icon'  => 'fa-print',
    'title' => 'Banner & Large Format Printing',
    'desc'  => 'Vinyl banners, roll-ups, hoardings, fabric displays â€” printed in-house, same-day available.',
    'url'   => home_url( '/product-category/banners-large-format/' ),
  ],
  [
    'icon'  => 'fa-building',
    'title' => 'Signage & 3D Letters',
    'desc'  => 'Acrylic, aluminium, LED and illuminated signage â€” fabricated and installed across the UAE.',
  ...
  [
    ...
    'desc'  => 'Custom stands, pop-ups, backdrops, event branding â€” turnkey solutions for trade shows.',
    'url'   => home_url( '/product-category/exhibitions-events/' ),
  ],
  [
    'icon'  => 'fa-sticky-note',
    'title' => 'Stickers & Branding',
    'desc'  => 'Die-cut stickers, wall graphics, floor decals, window frosting â€” any surface, any size.',
    'url'   => home_url( '/product-category/stickers-branding/' ),
  ],
  [
    'icon'  => 'fa-gift',
    'title' => 'Corporate Gifts & Promotions',
    'desc'  => 'Branded apparel, packaging, drinkware, executive kits â€” customised for your brand.',
    'url'   => home_url( '/product-category/promotional-gifts/' ),
  ],
];

/* â”€â”€ Portfolio images (verified existing) â”€â”€ */
$portfolio = [
  [ 'src' => '/wp-content/uploads/2022/03/Step-Repeat-Backdrop-2.jpg',      'alt' => 'Step & Repeat Backdrop â€” Corporate Event Dubai' ],
  [ 'src' => '/wp-content/uploads/2022/03/3D-Aluminum-Signage-2.jpg',       'alt' => '3D Aluminium Signage â€” Storefront Dubai' ],
  [ 'src' => '/wp-content/uploads/2022/03/Exhibition-Stands-1.jpg',         'alt' => 'Custom Exhibition Stand â€” Trade Show Dubai' ],
  [ 'src' => '/wp-content/uploads/2022/03/Vehicle-branding.png',            'alt' => 'Full Vehicle Wrap â€” Fleet Branding Dubai' ],
  [ 'src' => '/wp-content/uploads/2022/03/Events-Branding-2-1.jpg',        'alt' => 'Event Branding â€” Corporate Launch Dubai' ],
  [ 'src' => '/wp-content/uploads/2026/03/business-signage-storefront.jpg', 'alt' => 'Business Signage â€” Retail Storefront Dubai' ],
];

$instagram_url = 'https://www.instagram.com/efficientuae/';

/* â”€â”€ Curated social proof (selected, no feed widgets) â”€â”€ */
$google_reviews = [
  [
    'name'   => 'Ahmed R.',
    'rating' => '5.0',
...
/* â”€â”€ FAQ â”€â”€ */
$faqs = [
  [ 'q' => 'What is the turnaround time for printing?',    'a' => 'Standard orders are completed in 2â€“3 business days. Same-day printing is available for banners, business cards and select items if artwork is submitted before 10am.' ],
  [ 'q' => 'Do you offer design services?',                'a' => 'Yes â€” our in-house design team can create artwork from scratch or optimise your existing files for print at no extra charge on qualifying orders.' ],
  ...
  [ 'q' => 'Can I visit your facility?',                   'a' => 'Absolutely. Our production facility and showroom in Ras Al Khor Industrial Area 1 is open Saturdayâ€“Thursday, 8amâ€“8pm. Walk-ins welcome.' ],
...
<section id="ea-hp-hero">
  <div class="ea-hp-hero-inner">
    <div class="ea-hp-hero-content">
      ...
      <p>From large-format banners to 3D signage and vehicle wraps â€” we produce everything in-house at our Dubai facility. 18+ years of trusted service, same-day production available.</p>
    ...
    <div class="ea-hp-hero-img">
      <img src="/wp-content/uploads/2022/03/Exhibition-Stands-1.jpg"
           alt="Exhibition Setup and Branding Installation â€” Efficient Advertising Dubai"
...
<section id="ea-hp-trust-strip">
  <div class="ea-hp-container">
    <div class="ea-hp-trust-grid">
      ...
      <div class="ea-hp-trust-item">
        <strong>4.8â˜…</strong><span>Google Rating</span>
      </div>
    </div>
  </div>
</section>
...
<section id="ea-hp-services">
  <div class="ea-hp-container">
    <div class="ea-hp-section-header">
      ...
      <h2>Core Services</h2>
      <p>End-to-end printing, signage and branding â€” everything produced in-house at our Dubai facility.</p>
    </div>
...
<section id="ea-hp-products">
  <div class="ea-hp-container">
    <div class="ea-hp-section-header">
      ...
      <p>Browse our most popular categories â€” from banners and signage to corporate gifts.</p>
    </div>
    <div class="ea-hp-products-grid">
      ...
      <a href="<?php echo esc_url( $item['url'] ); ?>" class="ea-product-card">
        <div class="ea-product-card__img">
          <img src="<?php echo esc_url( $item['img'] ); ?>" alt="<?php echo esc_attr( $item['title'] ); ?> â€” Efficient Advertising Dubai" loading="lazy" width="400" height="300">
        </div>
        <div class="ea-product-card__body">
          <span class="ea-product-card__cat"><?php echo esc_html( $item['cat_name'] ); ?></span>
          <h4><?php echo esc_html( $item['title'] ); ?></h4>
          <p><?php echo esc_html( wp_trim_words( $item['excerpt'], 10, 'â€¦' ) ); ?></p>
...
<!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     SECTION 6 â€” SELECTED GOOGLE REVIEWS
     â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
  ...
  <div class="ea-hp-container">
    ...
    <div class="ea-hp-reviews-grid">
      ...
      <article class="ea-hp-review-card">
        <div class="ea-hp-review-stars" aria-label="Rated <?php echo esc_attr( $review['rating'] ); ?> out of 5">â˜…â˜…â˜…â˜…â˜…</div>
...
<!-- â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
     SECTION 7 â€” FEATURED YOUTUBE VIDEOS
     â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â• -->
  ...
  <div class="ea-hp-container">
    ...
    <div class="ea-hp-why-grid">
      <div class="ea-hp-why-card">
        ...
        <h3>100% In-House</h3>
        <p>Design, print and finishing all under one roof â€” no outsourcing, no delays, total quality control.</p>
      </div>
      <div class="ea-hp-why-card">
      ...
      <div class="ea-hp-why-card">
        ...
        <p>HP Latex and UV flatbed technology â€” vivid colours, durable finishes, indoor and outdoor rated.</p>
      </div>
      <div class="ea-hp-why-card">
        <div class="ea-hp-why-icon"><i class="fa fa-truck"></i></div>
        <h3>UAE-Wide Delivery</h3>
        <p>From Ras Al Khor to all seven Emirates â€” delivery and on-site installation services available.</p>
      </div>
    </div>
  </div>
</section>
