...
/* Enqueue product page assets — isolated to singular product context */
add_action( 'wp_head', function () {
    echo '<link rel="preconnect" href="https://fonts.googleapis.com">';
    echo '<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>';
}, 1 );
wp_enqueue_style( 'ea-pp-google-fonts', 'https://fonts.googleapis.com/css2?family=Syne:wght@400;500;600;700;800&family=Unbounded:wght@400;500;600;700&family=DM+Sans:opsz,wght@9..40,300;9..40,400;9..40,500;9..40,600;9..40,700&display=swap', [], null );
wp_enqueue_style( 'ea-premium-product', get_template_directory_uri() . '/css/premium-product.css', [ 'ea-pp-google-fonts' ], '1.0' );
...
$wa_num        = '971527966265';
$wa_text       = rawurlencode( 'Hi, I need a quote for: ' . html_entity_decode( $pp_title, ENT_QUOTES, 'UTF-8' ) . ' in Dubai' );
...
$_pp_cats = [
  ...
  'sticker-printing-dubai' => [
    ...
    'features' => [
      ['icon'=>'fa-tint','title'=>'Waterproof & UV-Resistant','desc'=>'All vinyl stickers are waterproof and UV-resistant for indoor and outdoor UAE conditions.'],
      ['icon'=>'fa-cut','title'=>'Custom Die-Cut','desc'=>'Contour-cut in any shape — circles, custom logos, silhouettes. No minimum for die-cuts.'],
  ...
  'exhibition-event-management' => [
    ...
    'features' => [
      ['icon'=>'fa-compass','title'=>'3D Design & Visualisation','desc'=>'Photorealistic 3D renders so you see your stand before a single panel is cut.'],
      ...
      ['icon'=>'fa-sync','title'=>'Reusable Systems','desc'=>'Modular stand components can be reconfigured for different booth sizes at future shows.'],
    ],
    'specs' => [
  ...
  'promotional-gifts-dubai' => [
    ...
    'features' => [
      ...
      ['icon'=>'fa-truck','title'=>'Fast Delivery','desc'=>'Stock items with branding: 3–5 working days. Custom-manufactured: 10–14 days.'],
    ],
    'specs' => [
  ...
  'plastic-bags-printing' => [
    ...
    'features' => [
      ...
      ['icon'=>'fa-paint-brush','title'=>'Custom Printing','desc'=>'Up to 6-colour flexographic printing or full digital print with your branding.'],
  ...
  'stationery-printing-dubai' => [
    ...
    'features' => [
      ...
      ['icon'=>'fa-paint-brush','title'=>'Pantone Matching','desc'=>'Exact brand colour reproduction using CMYK proofing and Pantone reference.'],
    ],
    'specs' => [
  ...
  'banners-printing' => [
    ...
    'features' => [
      ...
      ['icon'=>'fa-sun','title'=>'Outdoor Durable','desc'=>'UV-resistant inks on weatherproof materials — banners last 2–3 years outdoors in Dubai.'],
...
$_pp_default = [
  ...
  'features' => [
    ...
    ['icon'=>'fa-pencil-alt','title'=>'Free Design Support','desc'=>'Our in-house design team prepares and adjusts your artwork at no extra charge.'],
...
<?php if ( ! empty( $_GET['quote'] ) ) :
  $quote_status = sanitize_key( $_GET['quote'] );
  if ( 'success' === $quote_status ) : ?>
<div role="alert" style="margin:20px auto;max-width:900px;padding:14px 20px;background:#0f4c1e;border-left:4px solid #22c55e;border-radius:0 6px 6px 0;color:#dcfce7;display:flex;align-items:center;gap:10px;font-size:15px;">
  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
  Thank you &mdash; your quote request has been sent! We&rsquo;ll be in touch within 2 hours.
</div>
<?php elseif ( 'error' === $quote_status ) : ?>
<div role="alert" style="margin:20px auto;max-width:900px;padding:14px 20px;background:#4c0f0f;border-left:4px solid #ef4444;border-radius:0 6px 6px 0;color:#fee2e2;display:flex;align-items:center;gap:10px;font-size:15px;">
  <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
  Something went wrong &mdash; please check your details and try again, or contact us directly.
</div>
<?php endif; endif; ?>
    ...
    <div class="ea-pp-hero-grid">
      ...
      <div class="reveal">
        ...
        <div class="ea-pp-main-img" id="eaPPMainImg">
          <img src="<?php echo esc_url( $gallery[0]['url'] ); ?>" alt="<?php echo esc_attr( $gallery[0]['alt'] ); ?>" id="eaPPMainImgEl" loading="eager">
      ...
      <div class="reveal">
        ...
        <div class="ea-pp-cta-row">
          ...
          <a href="<?php echo esc_url( 'https://wa.me/' . $wa_num . '?text=' . $wa_text ); ?>" class="btn-green-solid" target="_blank" rel="noopener">
  ...
  <div class="container">
    ...
    <div class="ea-pp-features-grid">
      ...
      <div class="ea-pp-feature-card reveal">
        <div class="ea-pp-feature-ico"><i class="fas <?php echo esc_attr( $feat['icon'] ); ?>"></i></div>
      ...
      <div class="reveal">
        <div class="ea-pp-artwork-card">
          ...
          <div class="ea-pp-artwork-actions">
            <a href="<?php echo esc_url( 'https://wa.me/' . $wa_num . '?text=' . rawurlencode( 'Hi, I want to send artwork for: ' . html_entity_decode( $pp_title, ENT_QUOTES, 'UTF-8' ) ) ); ?>" class="btn-green-solid" target="_blank" rel="noopener">
              <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
              Send via WhatsApp
            </a>
            <a href="<?php echo esc_url( 'mailto:info@efficientadvt.com?subject=' . rawurlencode( 'Artwork for ' . html_entity_decode( $pp_title, ENT_QUOTES, 'UTF-8' ) ) ); ?>" class="btn-outline-dark">
              <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
              Email Artwork
            </a>
          </div>
  ...
  <div class="container">
    <div class="ea-pp-faq-grid">
      <div class="reveal">
        ...
        <a href="<?php echo esc_url( home_url('/contact-us/') ); ?>" class="btn-outline-dark" style="margin-top:8px;">More Questions? Ask Us</a>
      </div>
      <div class="reveal">
        <?php foreach ( $cfg['faq'] as $fi => $faq ) : ?>
  ...
  <div class="container">
    <div class="ea-pp-cta-inner reveal">
      ...
      <div class="ea-pp-cta-btns">
        ...
        <a href="<?php echo esc_url( 'https://wa.me/' . $wa_num . '?text=' . $wa_text ); ?>" class="btn-outline-amber" target="_blank" rel="noopener">
          <svg viewBox="0 0 24 24" fill="currentColor" width="17" height="17"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
          WhatsApp Us
        </a>
...
<!-- WhatsApp Float -->
<a href="<?php echo esc_url( 'https://wa.me/' . $wa_num . '?text=' . $wa_text ); ?>"
...
<div class="ea-pp-sticky-bar" role="navigation" aria-label="Quick actions">
  ...
  <a href="<?php echo esc_url( 'https://wa.me/' . $wa_num . '?text=' . $wa_text ); ?>" class="ea-pp-sticky-btn ea-pp-sticky-wa" target="_blank" rel="noopener">
  ...
  <div class="ea-modal-box">
    ...
    <div class="ea-modal-body">
      <form class="ea-quote-form" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
        ...
        <input type="hidden" name="product_url" value="<?php echo esc_attr( $pp_url ); ?>">
        <input type="text" name="ea_hp_field" value="" style="display:none!important" tabindex="-1" autocomplete="off" aria-hidden="true">
...
<div class="ea-pp-lightbox" id="eaPPLightbox" style="display:none" onclick="this.style.display='none'">
  ...
  <img id="eaPPLightboxImg" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///ywAAAAAAQABAAACAUwAOw==" alt="Product image">
</div>
...
(function(){
  ...
  /* Header is position:sticky — no manual margin offset needed */
})();
</script>
