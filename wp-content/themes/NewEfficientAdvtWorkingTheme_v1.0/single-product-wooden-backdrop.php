...
.ea-pg-trust-item{display:flex;align-items:center;gap:12px;font-family:'DM Sans',sans-serif;font-size:14px;font-weight:700;color:#1A1A2E;}
.ea-pg-trust-item .trust-ico{width:36px;height:36px;border-radius:50%;background:rgba(255,186,9,0.15);border:1.5px solid rgba(255,186,9,0.30);display:flex;align-items:center;justify-content:center;flex-shrink:0;}
.ea-pg-trust-item .trust-ico svg{fill:var(--amber);width:16px;height:16px;}
...
.ea-pg-file-spec{background:rgba(26,26,46,0.04);border:1px solid rgba(26,26,46,0.08);border-radius:8px;padding:9px 14px;font-family:'DM Sans',sans-serif;opacity:1 !important;}
.ea-pg-file-spec .fs-label{font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:1.2px;color:#8A5E00;display:block;margin-bottom:3px;opacity:1 !important;}
.ea-pg-file-spec .fs-val{font-size:13px;font-weight:600;color:#1A1A2E;opacity:1 !important;}
.ea-pg-artwork-actions { display: flex; gap: 12px; margin-top: 10px; }
.ea-pg-artwork-actions .btn-amber-solid { background: #16A34A !important; border-color: #16A34A !important; color: #fff !important; flex: 1; }
.ea-pg-artwork-actions .btn-amber-solid:hover { background: #15803d !important; }
.ea-pg-artwork-actions .btn-outline-dark { flex: 1; border: 1.5px solid #1A1A2E; color: #1A1A2E; font-weight: 700; }
    ...
    <div class="ea-pg-hero-grid">
      ...
      <div class="reveal">
        ...
        <div class="ea-pg-cta-row">
          ...
          <a href="https://wa.me/971527966265?text=Hi%2C%20I%20need%20a%20quote%20for%20wooden-backdrop-dubai" class="btn-amber-solid" style="background:#16A34A; border-color:#16A34A; color:#fff;" target="_blank" rel="noopener">
...
<section id="ea-pg-trust-bar" style="background:#FBFBF9; border-bottom:1px solid rgba(26,26,46,0.06); padding:24px 0;">
  <div class="container">
...
<!-- REVIEWS -->
<section id="ea-pg-reviews" style="background:#fff; padding:clamp(56px, 6vw, 100px) 0; border-top:1px solid rgba(26,26,46,0.08);">
  <div class="container">
    <div class="ea-pg-reviews-header reveal" style="text-align:center; margin-bottom:48px;">
