...
/* Enqueue premium-homepage.css only on product_cat archives — isolated, not global */
wp_enqueue_style(
  'ea-premium-homepage',
  get_template_directory_uri() . '/css/premium-homepage.css',
  [],
  '1.0'
);
...
/* SEO-optimised H1 overrides by slug — scoped Tier-1 authority terms */
$h1_overrides = [
  'exhibitions-events'   => 'Exhibition Stand Design &amp; Fabrication in Dubai',
  'signage'              => 'Custom Signage Solutions in Dubai',
  'vehicle-branding'     => 'Vehicle Branding &amp; Fleet Graphics in Dubai',
  'banners-large-format' => 'Large Format &amp; Hoarding Printing in Dubai',
];
$h1_display = isset( $h1_overrides[ $term_slug ] ) ? $h1_overrides[ $term_slug ] : esc_html( $term_name );
...
$sub_overrides = [
  'exhibitions-events'   => 'Custom exhibition stand design, fabrication and installation in Dubai — from portable pop-up displays to full modular builds for trade shows and events across the UAE.',
  'signage'              => 'Premium signage solutions in Dubai — 3D letters, illuminated signs, acrylic boards, aluminium fabrication and retail signage produced in-house and installed UAE-wide.',
  'vehicle-branding'     => 'Professional vehicle branding and fleet graphics in Dubai — full wraps, partial wraps and magnetic signage for cars, vans and trucks with UAE-wide installation.',
  'banners-large-format' => 'Large format and hoarding printing in Dubai — vinyl banners, building hoardings, roll-up stands and fabric displays produced in-house with same-day printing available.',
];
$sub   = ! empty( $term_desc ) ? $term_desc : ( isset( $sub_overrides[ $term_slug ] ) ? $sub_overrides[ $term_slug ] : 'Professional ' . strtolower( $term_name ) . ' printing and branding — produced in-house at our Dubai facility with same-day delivery across the UAE.' );
...
<section class="ea-cat-why">
  <div class="ea-hp-container">
    <div class="ea-hp-section-header">
      <span class="ea-hp-label">Why Businesses Trust Us</span>
