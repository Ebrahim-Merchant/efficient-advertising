...
<header class="relative pt-20 pb-32 overflow-hidden" style="background-color: #6B1D2D;">
    <div class="absolute inset-0 opacity-20 pointer-events-none">
        <div class="absolute top-[-20%] left-[-10%] w-[600px] h-[600px] rounded-full blur-[120px]" style="background-color: #EF4444;"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[500px] h-[500px] rounded-full blur-[100px]" style="background-color: #FCA5A5;"></div>
    </div>
