          ...
          <div class="ea-hdr-brand">
            <div class="logo">
              <a class="" href="<?php echo home_url(); ?>">
                <?php
                  $default_logo   = of_get_option('logo') ? of_get_option('logo') : get_template_directory_uri() . '/img/logo.png';
                  $white_logo_url = content_url( 'uploads/2024/11/efficient-logo-2.png' );
                  $is_dark_page   = is_front_page() || is_home();
                  $logo_src       = $is_dark_page ? $white_logo_url : $default_logo;
                ?>
