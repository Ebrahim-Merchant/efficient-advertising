...
/* Verification code button — matches Send Message style */
.ea-verify-btn {
...
.ea-verify-btn:hover { background: #f0b000; }
...
/* Verification code button — matches Send Message style (duplicate block removed) */
.ea-verify-note {
