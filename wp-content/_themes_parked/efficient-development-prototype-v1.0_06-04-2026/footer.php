...
<footer style="background:#0A0A14; margin:0; padding:0; border-top:3px solid #FFBA09;">
  ...
  <!-- Copyright -->
  <div style="background:#03030A; border-top:1px solid rgba(255,255,255,0.05); padding:10px 20px; display:flex; align-items:center; justify-content:center; position:relative;">
