      ...
      <div class="ea-slide">
        <div class="ea-slide-wrap">
          <div class="ea-slide-txt">
            ...
            <h2 class="ea-slide-h1">Custom <em>Backdrops</em><br>&amp; Pop-Up Displays</h2>
...
<section class="ea-bdhero" style="background: #0F172A; padding: 44px 0; overflow: visible; position: relative;">
...
.ea-bdhero__link:hover { color: #0F172A; opacity: 1; }
.ea-bdhero__imgwrap {
  width: 44%;
  flex-shrink: 0;
  position: relative;
...
.ea-bdhero__wa-mobile:hover { background: #128C7E; color: #fff; }
...
/* Hide Redundant Floating WA Icon (from Click to Chat plugin) on Mobile when sticky bar is active */
@media (max-width: 767px) {
  .ht-ctc-chat { display: none !important; }
}

/* Ensure consistent brand-green (#25D366) across all custom WA buttons */
.ea-wa-cta-btn, .ea-bdhero__wa-circle, .ea-bdhero__wa-mobile, .sp-btn-wa, .ea-sticky-wa {
  --wa-green: #25D366;
}
</style>
...
<section class="section-bar whychooseus-section" style="background:#FFBA09; padding:64px 0 52px; position:relative; overflow:hidden; margin:0 !important;">
...
<section style="background:#f8fafc; padding:64px 0 60px;">
  <div class="container">
    <div style="text-align:center; margin-bottom:48px;">
      <p style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#E5A800;margin:0 0 10px;">Simple &amp; Fast</p>
      <h2 style="font-size:32px;font-weight:800;color:#0F172A;margin:0 0 14px;position:relative;display:inline-block;padding-bottom:16px;">
        How It Works
        <span style="position:absolute;bottom:0;left:50%;transform:translateX(-50%);width:56px;height:4px;background:#FFBA09;border-radius:2px;"></span>
      </h2>
    ...
    <div style="text-align:center; margin-top:40px;">
      <a href="https://api.whatsapp.com/send?phone=971527966265&amp;text=Hi%2C+I%27d+like+to+start+a+print+order"
         ...
         style="display:inline-block;background:#25D366;color:#fff;padding:14px 32px;border-radius:6px;font-size:15px;font-weight:700;text-decoration:none;">
...
.ea-hiw-num { font-size:11px; font-weight:800; letter-spacing:2px; color:#E5A800; margin-bottom:10px; }
.ea-hiw-icon { font-size:38px; line-height:1; margin-bottom:14px; }
.ea-hiw-title { font-size:16px; font-weight:700; color:#0F172A; margin:0 0 10px; }
.ea-hiw-desc { font-size:13px; color:#64748b; line-height:1.7; margin:0; }
.ea-hiw-connector {
  width:40px; height:2px;
  background:linear-gradient(90deg,#FFBA09,#E5A800);
...
<section id="ea-yt-section" style="background:#0F172A; padding:50px 0;">
  <div class="container">

    <div class="row pb-30 text-center">
      <div class="col-sm-8 col-sm-offset-2 col-lg-6 col-lg-offset-3">
        <div class="creative_heading">
          <h4 style="color:#FFBA09;">OUR WORK</h4>
    ...
    <div class="row" style="display:flex; flex-wrap:wrap; justify-content:center;">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12" style="margin-bottom:24px; padding:0 10px;">
        <div style="background:#0d0d1a; border-radius:10px; overflow:hidden;">
          ...
          <div style="padding:12px; text-align:center;">
            <span style="background:#FFBA09; color:#000; font-size:11px; font-weight:700; padding:4px 12px; border-radius:20px; text-transform:uppercase; letter-spacing:0.5px;">Branding</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12" style="margin-bottom:24px; padding:0 10px;">
        <div style="background:#0d0d1a; border-radius:10px; overflow:hidden;">
          ...
          <div style="padding:12px; text-align:center;">
            <span style="background:#FFBA09; color:#000; font-size:11px; font-weight:700; padding:4px 12px; border-radius:20px; text-transform:uppercase; letter-spacing:0.5px;">Exhibitions</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12" style="margin-bottom:24px; padding:0 10px;">
        <div style="background:#0d0d1a; border-radius:10px; overflow:hidden;">
          ...
          <div style="padding:12px; text-align:center;">
            <span style="background:#FFBA09; color:#000; font-size:11px; font-weight:700; padding:4px 12px; border-radius:20px; text-transform:uppercase; letter-spacing:0.5px;">Signage</span>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12" style="margin-bottom:24px; padding:0 10px;">
        <div style="background:#0d0d1a; border-radius:10px; overflow:hidden;">
          ...
          <div style="padding:12px; text-align:center;">
            <span style="background:#FFBA09; color:#000; font-size:11px; font-weight:700; padding:4px 12px; border-radius:20px; text-transform:uppercase; letter-spacing:0.5px;">Vehicle Branding</span>
          </div>
        </div>
      </div>
    ...
    <div style="text-align:center; margin-top:10px;">
      ...
      <a href="/contact-us/" class="cta-primary"
         style="display:inline-block; background:#8B1A1A; color:#fff; padding:14px 32px;
                border-radius:6px; font-size:15px; font-weight:700; text-decoration:none; margin:6px;">
        Get a Free Quote
      </a>
    </div>
...
<!-- URGENCY CTA BANNER -->
<section style="background:linear-gradient(135deg,#0F172A 0%,#162032 60%,#0f172a 100%); padding:48px 0; position:relative; overflow:hidden;">
  <div style="position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,#FFBA09,#E5A800);"></div>
  <div class="container">
    <div class="ea-urgency-inner">
      <div>
        <p style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#FFBA09;margin:0 0 8px;">&#9889; SAME-DAY PRINTING AVAILABLE IN DUBAI</p>
...
.ea-urgency-btn-wa {
  ...
  background:#25D366; color:#fff; padding:13px 26px; border-radius:6px;
  font-size:14px; font-weight:700; text-decoration:none; white-space:nowrap;
}
.ea-urgency-btn-wa:hover { background:#128C7E; color:#fff; }
.ea-urgency-btn-call {
...
<section id="ea-quote" style="background:#F9FAFB; padding:64px 0 68px;">
  <div class="container">
    <div class="row">
      <div class="col-md-5" style="margin-bottom:32px;">
        <p style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#E5A800;margin:0 0 10px;">Free &amp; Fast</p>
        <h2 style="font-size:30px;font-weight:800;color:#0F172A;margin:0 0 16px;line-height:1.3;">Get a Free<br>Printing Quote</h2>
        ...
        <ul style="list-style:none;padding:0;margin:0;">
          <li style="display:flex;align-items:center;gap:10px;margin-bottom:12px;font-size:14px;color:#374151;"><span style="width:24px;height:24px;background:#FFF8E1;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0;">&#10003;</span>In-house production &mdash; direct pricing</li>
          <li style="display:flex;align-items:center;gap:10px;margin-bottom:12px;font-size:14px;color:#374151;"><span style="width:24px;height:24px;background:#FFF8E1;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0;">&#10003;</span>Same-day printing available</li>
          <li style="display:flex;align-items:center;gap:10px;margin-bottom:12px;font-size:14px;color:#374151;"><span style="width:24px;height:24px;background:#FFF8E1;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0;">&#10003;</span>Free design support included</li>
          <li style="display:flex;align-items:center;gap:10px;font-size:14px;color:#374151;"><span style="width:24px;height:24px;background:#FFF8E1;border-radius:50%;display:inline-flex;align-items:center;justify-content:center;font-size:12px;flex-shrink:0;">&#10003;</span>Delivery across all UAE emirates</li>
        </ul>
      </div>
      <div class="col-md-7">
          ...
          <form id="ea-quote-form" onsubmit="eaSubmitQuote(event)" novalidate>
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-bottom:16px;">
              <div>
                ...
                <input type="text" id="eq-name" placeholder="e.g. Ahmed Hassan" required
                  ...
                  onfocus="this.style.borderColor='#FFBA09'" onblur="this.style.borderColor='#e2e8f0'">
              </div>
              <div>
            ...
            <div style="margin-bottom:20px;">
              ...
              <textarea id="eq-details" rows="3" placeholder="e.g. 2m x 1m banner, qty 50, needed by Friday..."
                ...
                onfocus="this.style.borderColor='#FFBA09'" onblur="this.style.borderColor='#e2e8f0'"></textarea>
            </div>
            <button type="submit"
              style="width:100%;background:#25D366;color:#fff;padding:14px;border:none;border-radius:8px;font-size:15px;font-weight:700;cursor:pointer;display:flex;align-items:center;justify-content:center;gap:10px;transition:background 0.2s;"
...
<!-- ══════════════════════════════════════════════════════════
     ...
     ══════════════════════════════════════════════════════════ -->
<section id="ea-faq" style="background:#F9FAFB; padding:64px 0 72px;">
  <div class="container">

    <!-- Section heading -->
    <div class="row text-center" style="margin-bottom:44px;">
      <div class="col-sm-12">
        <p style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#E5A800;margin-bottom:10px;">Got Questions?</p>
        <h2 style="font-size:32px;font-weight:800;color:#0F172A;margin:0 0 14px;position:relative;display:inline-block;padding-bottom:16px;">
          Frequently Asked Questions
          <span style="position:absolute;bottom:0;left:50%;transform:translateX(-50%);width:60px;height:4px;background:#FFBA09;border-radius:2px;"></span>
        </h2>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="ea-faq-item">
          ...
          <div class="ea-faq-a">
            <p>Yes. We offer same-day and express printing for selected products. Contact us via WhatsApp or call <a href="tel:+971527966265" style="color:#E5A800;">+971 52 796 6265</a> with your order details and we'll confirm the earliest possible turnaround.</p>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="ea-faq-item">
          ...
          <div class="ea-faq-a">
            <p>You can get an instant quote via WhatsApp on <a href="https://wa.me/971527966265" target="_blank" rel="noopener" style="color:#25D366;">+971 52 796 6265</a>, by calling us, or by using the <a href="/contact" style="color:#E5A800;">Contact Us</a> form. Share your product type, size, quantity, and deadline for the fastest response.</p>
          </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-7" style="margin-bottom:28px;">
        <h2 style="font-size:24px; font-weight:800; color:#0F172A; margin:0 0 20px; line-height:1.4;">
      ...
      <div class="col-md-5" style="margin-bottom:28px;">
        <div style="background:#fff; border-radius:12px; padding:24px; box-shadow:0 2px 12px rgba(0,0,0,0.07); margin-bottom:20px;">
          <h3 style="font-size:15px; font-weight:700; color:#0F172A; margin:0 0 14px;">Our Services in Dubai &amp; UAE</h3>
          <ul style="list-style:none; padding:0; margin:0;">
            <?php
            $seo_services = [
            ...
            foreach ( $seo_services as $svc ) {
              echo '<li style="font-size:13px;color:#374151;padding:5px 0;border-bottom:1px solid #f1f5f9;display:flex;align-items:center;gap:8px;"><span style="color:#E5A800;font-weight:700;flex-shrink:0;">&#10003;</span>' . $svc . '</li>';
            }
            ?>
          </ul>
        </div>
        <div style="background:linear-gradient(135deg,#1E293B,#0F172A); border-radius:12px; padding:24px; color:#fff;">
          ...
          <a href="tel:+971527966265" style="color:#FFBA09; font-size:15px; font-weight:700; text-decoration:none;">&#128222; +971 52 796 6265</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row text-center" style="margin-bottom:36px;">
      <div class="col-sm-12">
        ...
        <h2 style="font-size:30px; font-weight:800; color:#0F172A; margin:0 0 14px; position:relative; display:inline-block; padding-bottom:14px;">
          Latest News &amp; Blog
          <span style="display:block; width:56px; height:3px; background:#FFBA09; border-radius:2px; position:absolute; bottom:0; left:50%; transform:translateX(-50%);"></span>
        </h2>
      </div>
    </div>
      ...
      <div class="col-md-4 col-sm-6" style="margin-bottom:32px;">
        <div style="background:#fff; border-radius:4px; overflow:hidden; box-shadow:0 1px 6px rgba(0,0,0,.1); height:100%; display:flex; flex-direction:column;">
          ...
          <a href="<?php echo $post_url; ?>" style="display:block; position:relative; overflow:hidden; flex-shrink:0;">
            ...
            <?php else : ?>
            <div style="width:100%; height:210px; background:linear-gradient(135deg,#1E293B 0%,#0F172A 100%); display:flex; align-items:center; justify-content:center;">
            ...
            <?php endif; ?>
            <!-- Date badge -->
            <div style="position:absolute; top:12px; left:12px; background:#FFBA09; color:#000; border-radius:50%; width:54px; height:54px; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; line-height:1.1;">
          ...
          <div style="padding:14px 16px 18px; flex:1; display:flex; flex-direction:column;">
            <p style="font-size:12px; color:#E5A800; margin:0 0 6px 0; font-weight:600;">Posted by <?php the_author(); ?> -</p>
            <h3 style="font-size:15px; font-weight:700; line-height:1.45; color:#0F172A; margin:0; flex:1;">
