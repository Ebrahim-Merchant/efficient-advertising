...
.ea-pg-opt-btn { padding:9px 16px; background:rgba(255,255,255,0.04); border:1.5px solid rgba(255,255,255,0.12); border-radius:var(--r-sm); font-family:'Gotham',sans-serif; font-size:13px; font-weight:500; color:rgba(255,255,255,0.72); cursor:pointer; transition:border-color .18s,background .18s,color .18s; text-align:center; }
...
.ea-pg-wa-link { display:flex; align-items:center; gap:8px; font-family:'Gotham',sans-serif; font-size:13px; color:#4ade80; text-decoration:none; transition:color .2s; margin-bottom:24px; }
.ea-pg-wa-link:hover { color:#86efac; }
.ea-pg-trust { display:flex; flex-wrap:wrap; gap:10px; padding-top:20px; border-top:1px solid rgba(255,255,255,0.07); }
...
/* Trust bar */
#ea-pg-trust-bar { background:#0A0A14; border-bottom:1px solid rgba(255,255,255,0.06); padding:24px 0; }
#ea-pg-trust-bar .ea-pg-trust-item { color:rgba(255,255,255,0.55); }
/* Features */
...
.ea-pg-specs-header h2 { font-family:'Gotham',sans-serif; font-size:clamp(22px,2.4vw,38px); font-weight:800; color:#1A1A2E; margin:0 0 10px; }
.ea-pg-specs-header p { font-family:'Gotham',sans-serif; font-size:clamp(14px,1vw,16px); color:rgba(26,26,46,0.58); }
...
.ea-pg-tab { font-family:'Gotham',sans-serif; font-size:13px; font-weight:600; color:rgba(26,26,46,0.50); padding:10px 20px; background:none; border:none; border-bottom:2px solid transparent; cursor:pointer; transition:color .2s,border-color .2s; margin-bottom:-1px; }
.ea-pg-tab:hover { color:rgba(26,26,46,0.80); }
.ea-pg-tab.active { color:var(--amber-dk); border-bottom-color:var(--amber); }
...
.ea-pg-spec-table td { font-family:'Gotham',sans-serif; font-size:clamp(13px,0.95vw,15px); padding:14px 16px; vertical-align:top; line-height:1.6; }
.ea-pg-spec-table td:first-child { color:var(--amber-dk); font-weight:700; width:38%; white-space:nowrap; }
...
/* Reviews */
.reviews { padding:clamp(56px,6vw,100px) 0; background:#fff; border-top:1px solid rgba(26,26,46,0.08); }
.reviewshadow { max-width:1100px; margin:0 auto; }
/* FAQ */
...
/* Modal */
.ea-modal-overlay { position:fixed; inset:0; background:rgba(0,0,0,0.6); backdrop-filter:blur(4px); z-index:99998; display:none; align-items:center; justify-content:center; padding:20px; }
.ea-modal-overlay.active { display:flex; }
.ea-modal-box { background:#fff; border-radius:var(--r-md); width:100%; max-width:540px; box-shadow:var(--shadow-md); overflow:hidden; }
.ea-modal-header { background:var(--tx); color:#fff; padding:20px 24px; display:flex; align-items:center; justify-content:space-between; }
.ea-modal-header h3 { font-family:'Gotham',sans-serif; font-size:17px; font-weight:700; margin:0; display:flex; align-items:center; gap:10px; }
.ea-modal-close { background:none; border:none; color:rgba(255,255,255,0.60); font-size:20px; cursor:pointer; padding:0; }
.ea-modal-body { padding:24px; }
.ea-form-row { display:grid; grid-template-columns:1fr 1fr; gap:16px; margin-bottom:16px; }
.ea-form-group { display:flex; flex-direction:column; gap:6px; margin-bottom:16px; }
.ea-form-group label { font-family:'Gotham',sans-serif; font-size:12px; font-weight:700; text-transform:uppercase; letter-spacing:0.8px; color:var(--tx-muted); }
.ea-form-group input,.ea-form-group textarea { border:1.5px solid var(--border); border-radius:var(--r-sm); padding:10px 14px; font-family:'Gotham',sans-serif; font-size:14px; color:var(--tx); outline:none; transition:border-color .2s; }
.ea-form-group input:focus,.ea-form-group textarea:focus { border-color:var(--amber); }
.ea-form-submit { background:var(--amber); color:var(--tx); font-family:'Gotham',sans-serif; font-size:14px; font-weight:700; padding:13px 28px; border-radius:var(--r-sm); border:none; cursor:pointer; width:100%; display:flex; align-items:center; justify-content:center; gap:8px; transition:background .2s; }
...
<section id="ea-pg-trust-bar">
  <div class="container">
    <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:clamp(20px,4vw,60px);">
      <div class="ea-pg-trust-item"><div class="trust-ico"><svg viewBox="0 0 24 24" width="13" height="13"><path d="M12 1l3.09 6.26L22 8.27l-5 4.87 1.18 6.88L12 16.77l-6.18 3.25L7 13.14 2 8.27l6.91-1.01L12 1z"/></svg></div>18+ Years Experience</div>
      <div class="ea-pg-trust-item"><div class="trust-ico"><svg viewBox="0 0 24 24" width="13" height="13"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg></div>500+ Events Served</div>
      <div class="ea-pg-trust-item"><div class="trust-ico"><svg viewBox="0 0 24 24" width="13" height="13"><path d="M5 12l5 5L20 7"/></svg></div>Free Design Support</div>
      <div class="ea-pg-trust-item"><div class="trust-ico"><svg viewBox="0 0 24 24" width="13" height="13"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>UAE-Wide Coverage</div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="ea-pg-faq-grid">
      ...
      <div class="ea-pg-acc-list reveal">
        ...
        <div class="ea-pg-acc-item<?php echo $i === 0 ? ' open' : ''; ?>">
          <button class="ea-pg-acc-trigger" aria-expanded="<?php echo $i === 0 ? 'true' : 'false'; ?>">
...
<div class="ea-modal-overlay" id="orderModal" role="dialog" aria-modal="true" aria-label="Request a Quote">
  <div class="ea-modal-box">
    ...
    <p><?php echo esc_html( $sp_title ); ?> &mdash; we will reply within 2 hours.</p>
    <form class="ea-modal-form" action="https://formspree.io/f/xdovkoje" method="POST">
      ...
      <div class="ea-mf-row">
        ...
        <label>Phone / WhatsApp <input type="tel" name="phone" placeholder="+971 50 000 0000" required></label>
      </div>
      <label>Product Details <textarea name="message" rows="3" placeholder="Size, quantity, material, artwork status..."></textarea></label>
      <button type="submit" class="ea-mf-submit">Send Request</button>
    </form>
  </div>
</div>
...
(function(){
  ...
  document.querySelectorAll('.sp-thumb').forEach(function(t){
    t.addEventListener('click',function(){
      document.querySelectorAll('.sp-thumb').forEach(function(x){ x.classList.remove('active'); });
      t.classList.add('active');
      var main = document.querySelector('.sp-main-img');
      if(main){ main.src = t.getAttribute('data-full') || t.src; }
    });
  });
  document.querySelectorAll('.ea-opt-btn').forEach(function(b){
    b.addEventListener('click',function(){
      var grp = b.closest('.ea-opt-group');
      if(grp){grp.querySelectorAll('.ea-opt-btn').forEach(function(x){x.classList.remove('active');});}
  ...
  document.querySelectorAll('.ea-pg-tab-btn').forEach(function(tb){
    tb.addEventListener('click',function(){
      var wrap = tb.closest('.ea-pg-tabs-wrap');
      if(!wrap) return;
      wrap.querySelectorAll('.ea-pg-tab-btn').forEach(function(x){x.classList.remove('active');});
      wrap.querySelectorAll('.ea-pg-tab-panel').forEach(function(x){x.classList.remove('active');});
      tb.classList.add('active');
      var p = wrap.querySelector('#' + tb.dataset.tab);
  ...
  var lbImg = lb ? lb.querySelector('.ea-lb-img') : null;
  var lbSrcs = [];
  var lbIdx = 0;
  if(lb){
    document.querySelectorAll('.sp-gallery-img').forEach(function(img){
      img.style.cursor='zoom-in';
      img.addEventListener('click',function(){
        lbSrcs = Array.from(document.querySelectorAll('.sp-gallery-img')).map(function(i){ return i.src; });
        lbIdx = lbSrcs.indexOf(img.src);
        lbImg.src = lbSrcs[lbIdx];
        lb.classList.add('active');
        document.body.style.overflow='hidden';
      });
    });
    lb.querySelector('.ea-lb-close').addEventListener('click',function(){ lb.classList.remove('active'); document.body.style.overflow=''; });
    lb.querySelector('.ea-lb-prev').addEventListener('click',function(){ lbIdx=(lbIdx-1+lbSrcs.length)%lbSrcs.length; lbImg.src=lbSrcs[lbIdx]; });
    lb.querySelector('.ea-lb-next').addEventListener('click',function(){ lbIdx=(lbIdx+1)%lbSrcs.length; lbImg.src=lbSrcs[lbIdx]; });
    lb.addEventListener('click',function(e){ if(e.target===lb){ lb.classList.remove('active'); document.body.style.overflow=''; } });
  }
